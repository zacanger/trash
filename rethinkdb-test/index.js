...
r.table('people').insert([
  {name: 'Z', occupation: 'student',
  posts: [{title: 'foo', content: 'so muchblahblahblah'},
          {title: 'bar', content: 'words words words'},
          {title: 'quux', content: 'baz'}]},
  {name: 'asdf', occupation: 'god',
  posts: [{title: 'let there be', content: 'stuff'},
