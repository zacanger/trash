...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__25441__auto__,writer__25442__auto__,opt__25443__auto__){
return cljs.core._write.call(null,writer__25442__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__31342 = o;
(G__31342[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__31344__i < G__31344__a.length) {G__31344__a[G__31344__i] = arguments[G__31344__i + 0]; ++G__31344__i;}
  args = new cljs.core.IndexedSeq(G__31344__a,0);
} 
...
if(cljs.core.truth_((function (){var and__24823__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__24823__auto__){
var and__24823__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__31351 = jsprops;
(G__31351["defaultValue"] = value);

(G__31351["onChange"] = ((function (G__31351,v,value,on_change){
return (function (p1__31348_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__31348_SHARP_);
});})(G__31351,v,value,on_change))
);

(G__31351["ref"] = ((function (G__31351,v,value,on_change){
return (function (p1__31349_SHARP_){
return (this$["cljsInputElement"] = p1__31349_SHARP_);
});})(G__31351,v,value,on_change))
);
...
var vec__31358 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__31358,(0),null);
var id = cljs.core.nth.call(null,vec__31358,(1),null);
var class$ = cljs.core.nth.call(null,vec__31358,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___31363 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___31363 == null)){
} else {
var key_31364 = temp__4661__auto___31363;
(jsprops["key"] = key_31364);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__31366 = (new reagent.impl.template.NativeWrapper());
(G__31366["name"] = c);
...
var len__25910__auto___31372 = arguments.length;
var i__25911__auto___31373 = (0);
while(true){
if((i__25911__auto___31373 < len__25910__auto___31372)){
args__25917__auto__.push((arguments[i__25911__auto___31373]));

var G__31374 = (i__25911__auto___31373 + (1));
i__25911__auto___31373 = G__31374;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__25918__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq31370){
var G__31371 = cljs.core.first.call(null,seq31370);
var seq31370__$1 = cljs.core.next.call(null,seq31370);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__31371,seq31370__$1);
});
...
break;
default:
var G__31378 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__31378;
continue;
...
var n__25750__auto___31381 = a.length;
var i_31382 = (0);
while(true){
if((i_31382 < n__25750__auto___31381)){
(a[i_31382] = reagent.impl.template.as_element.call(null,(a[i_31382])));
...
var a = cljs.core.into_array.call(null,s);
var n__25750__auto___31384 = a.length;
var i_31385 = (0);
while(true){
if((i_31385 < n__25750__auto___31384)){
var val_31386 = (a[i_31385]);
if((cljs.core.vector_QMARK_.call(null,val_31386)) && ((reagent.impl.template.key_from_vec.call(null,val_31386) == null))){
(o["no-key"] = true);
} else {
}

(a[i_31385] = reagent.impl.template.as_element.call(null,val_31386));
...
var ctx = ({});
var vec__31391 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__31391,(0),null);
var derefed = cljs.core.nth.call(null,vec__31391,(1),null);
...
var G__31395 = (cljs.core.count.call(null,argv) - first_child);
switch (G__31395) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__31395){
...
//# sourceMappingURL=template.js.map?rel=1492365306436