...
return (new CustomEvent(event_name,(function (){var obj35330 = {"detail":data};
return obj35330;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__24823__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__24823__auto__)){
var and__24823__auto____$1 = (window["CustomEvent"]);
...
var args35335 = [];
var len__25910__auto___35341 = arguments.length;
var i__25911__auto___35342 = (0);
while(true){
if((i__25911__auto___35342 < len__25910__auto___35341)){
args35335.push((arguments[i__25911__auto___35342]));

var G__35343 = (i__25911__auto___35342 + (1));
i__25911__auto___35342 = G__35343;
continue;
} else {
}
break;
...
var f = (function (){var pred__35338 = cljs.core._EQ_;
var expr__35339 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35338.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35339))){
return ((function (pred__35338,expr__35339){
return (function (p1__35331_SHARP_){
return console.warn(p1__35331_SHARP_);
});
;})(pred__35338,expr__35339))
} else {
if(cljs.core.truth_(pred__35338.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35339))){
return ((function (pred__35338,expr__35339){
return (function (p1__35332_SHARP_){
return console.debug(p1__35332_SHARP_);
});
;})(pred__35338,expr__35339))
} else {
if(cljs.core.truth_(pred__35338.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35339))){
return ((function (pred__35338,expr__35339){
return (function (p1__35333_SHARP_){
return console.error(p1__35333_SHARP_);
});
;})(pred__35338,expr__35339))
} else {
return ((function (pred__35338,expr__35339){
return (function (p1__35334_SHARP_){
return console.log(p1__35334_SHARP_);
});
;})(pred__35338,expr__35339))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35345){
var map__35348 = p__35345;
var map__35348__$1 = ((((!((map__35348 == null)))?((((map__35348.cljs$lang$protocol_mask$partition0$ & (64))) || (map__35348.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__35348):map__35348);
var opts = map__35348__$1;
var eval_fn = cljs.core.get.call(null,map__35348__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35350_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__35352,(0),null);
...
var args35355 = [];
var len__25910__auto___35358 = arguments.length;
var i__25911__auto___35359 = (0);
while(true){
if((i__25911__auto___35359 < len__25910__auto___35358)){
args35355.push((arguments[i__25911__auto___35359]));

var G__35360 = (i__25911__auto___35359 + (1));
i__25911__auto___35359 = G__35360;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args35355.length)].join('')));
...
if(cljs.core.truth_((function (){var and__24823__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1492365310058