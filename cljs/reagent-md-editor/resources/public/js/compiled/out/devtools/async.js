...
var o__38168__auto___39279 = (function (){var o__38168__auto__ = (function (){var o__38168__auto__ = Promise;
return goog.object.get(o__38168__auto__,"resolve").call(o__38168__auto__);
})();
return goog.object.get(o__38168__auto__,"then").call(o__38168__auto__,callback);
})();
goog.object.get(o__38168__auto___39279,"catch").call(o__38168__auto___39279,devtools.async.rethrow_outside_promise);
...
var G__39281_39282 = Error;
var target__38187__auto___39283 = G__39281_39282;
if(cljs.core.truth_(target__38187__auto___39283)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__39281_39282)].join('')),cljs.core.str("\n"),cljs.core.str("target__38187__auto__")].join('')));
}

goog.object.set(target__38187__auto___39283,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1492365315201