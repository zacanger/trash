...
var reader = (function (){var or__24835__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__24835__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__24835__auto__)){
return or__24835__auto__;
} else {
return (128);
...
}catch (e39305){var _e = e39305;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___39308 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___39308)){
var seen_errors_39309 = temp__4655__auto___39308;
if(cljs.core.truth_(seen_errors_39309.has(self))){
} else {
seen_errors_39309.add(self);

var temp__4657__auto___39310 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___39310)){
var sense_39311 = temp__4657__auto___39310;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_39311)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1492365315345