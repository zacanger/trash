...
var len__25910__auto___38566 = arguments.length;
var i__25911__auto___38567 = (0);
while(true){
if((i__25911__auto___38567 < len__25910__auto___38566)){
args__25917__auto__.push((arguments[i__25911__auto___38567]));

var G__38568 = (i__25911__auto___38567 + (1));
i__25911__auto___38567 = G__38568;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__25918__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq38563){
var G__38564 = cljs.core.first.call(null,seq38563);
var seq38563__$1 = cljs.core.next.call(null,seq38563);
var G__38565 = cljs.core.first.call(null,seq38563__$1);
var seq38563__$2 = cljs.core.next.call(null,seq38563__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__38564,G__38565,seq38563__$2);
});
...
if(cljs.core.truth_((function (){var or__24835__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__25441__auto__,writer__25442__auto__,opt__25443__auto__){
return cljs.core._write.call(null,writer__25442__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__24823__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__24823__auto__){
var or__24835__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__24835__auto__)){
return or__24835__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__38569_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__38569_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__38578__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__24835__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e38582){var e__38193__auto__ = e38582;
return false;
}})();
if(cljs.core.truth_(or__24835__auto__)){
return or__24835__auto__;
...
}catch (e38584){var e__38193__auto__ = e38584;
return false;
}}
})())){
...
var _STAR_current_state_STAR_38589 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__38590 = opts;
var map__38590__$1 = ((((!((map__38590 == null)))?((((map__38590.cljs$lang$protocol_mask$partition0$ & (64))) || (map__38590.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38590):map__38590);
var markup_db = cljs.core.get.call(null,map__38590__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_38589;
}});
...
;
var temp__4655__auto___38595 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___38595)){
var managed_print_level_38596 = temp__4655__auto___38595;
var _STAR_print_level_STAR_38594_38597 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_38596;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_38594_38597,managed_print_level_38596,temp__4655__auto___38595,writer,opts,job_fn){
return (function (p1__38592_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__38592_SHARP_,null);
});})(_STAR_print_level_STAR_38594_38597,managed_print_level_38596,temp__4655__auto___38595,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_38594_38597;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1492365313865