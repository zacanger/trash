...
var len__25910__auto___38557 = arguments.length;
var i__25911__auto___38558 = (0);
while(true){
if((i__25911__auto___38558 < len__25910__auto___38557)){
args__25917__auto__.push((arguments[i__25911__auto___38558]));

var G__38559 = (i__25911__auto___38558 + (1));
i__25911__auto___38558 = G__38559;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__25918__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq38555){
var G__38556 = cljs.core.first.call(null,seq38555);
var seq38555__$1 = cljs.core.next.call(null,seq38555);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__38556,seq38555__$1);
});
...
return (p1__38560_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1492365313727