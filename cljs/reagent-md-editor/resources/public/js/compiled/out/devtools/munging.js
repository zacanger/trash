...
var o__38168__auto__ = (function (){var temp__4657__auto__ = goog.object.get(window,"cljs");
if(cljs.core.truth_(temp__4657__auto__)){
var o__38180__auto__ = temp__4657__auto__;
return goog.object.get(o__38180__auto__,"core");
} else {
return null;
}
})();
return goog.object.get(o__38168__auto__,"js_reserved_QMARK_").call(o__38168__auto__,x);
});
devtools.munging.get_fn_source_safely = (function devtools$munging$get_fn_source_safely(f){
try{var o__38168__auto__ = f;
return goog.object.get(o__38168__auto__,"toString").call(o__38168__auto__);
}catch (e38379){var _ = e38379;
return "";
}});
...
try{var o__38168__auto___38382 = t;
goog.object.get(o__38168__auto___38382,"cljs$lang$ctorPrWriter").call(o__38168__auto___38382,t,writer);
}catch (e38381){var __38383 = e38381;
}
...
var char_code = (function (){var o__38168__auto__ = (new String(char$));
return goog.object.get(o__38168__auto__,"charCodeAt").call(o__38168__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38168__auto__ = String;
return goog.object.get(o__38168__auto__,"fromCharCode").call(o__38168__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38385 = num_code;
switch (G__38385) {
case (1):
return (185);
...
var o__38168__auto__ = String;
return goog.object.get(o__38168__auto__,"fromCharCode").call(o__38168__auto__,superscript_code);
});
/**
...
}catch (e38391){var e__38193__auto__ = e38391;
return false;
}})())){
...
var vec__38392 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__38392,(0),null);
...
var or__24835__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
var temp__4657__auto____$1 = goog.object.get(o__38181__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__38180__auto__ = temp__4657__auto____$1;
return goog.object.get(o__38180__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__25910__auto___38401 = arguments.length;
var i__25911__auto___38402 = (0);
while(true){
if((i__25911__auto___38402 < len__25910__auto___38401)){
args__25917__auto__.push((arguments[i__25911__auto___38402]));

var G__38403 = (i__25911__auto___38402 + (1));
i__25911__auto___38402 = G__38403;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__25918__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38397){
var vec__38398 = p__38397;
var ns_detector = cljs.core.nth.call(null,vec__38398,(0),null);
var effective_detector = (function (){var or__24835__auto__ = ns_detector;
if(cljs.core.truth_(or__24835__auto__)){
return or__24835__auto__;
} else {
...
var G__38404 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__38405 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__38404;
remaining_tokens = G__38405;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38395){
var G__38396 = cljs.core.first.call(null,seq38395);
var seq38395__$1 = cljs.core.next.call(null,seq38395);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__38396,seq38395__$1);
});
...
break;
default:
var o__38168__auto__ = window;
return goog.object.get(o__38168__auto__,"parseInt").call(o__38168__auto__,arity,(10));
...
var vec__38413 = cljs.core.split_with.call(null,(function (p1__38409_SHARP_){
return cljs.core.not_EQ_.call(null,p1__38409_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__38413,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__38413,(1),null);
...
var vec__38419 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__38419,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__38419,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__38422 = cljs.core.rest.call(null,remaining_tokens);
var G__38423 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__38422;
name_tokens = G__38423;
continue;
} else {
...
var args38424 = [];
var len__25910__auto___38436 = arguments.length;
var i__25911__auto___38437 = (0);
while(true){
if((i__25911__auto___38437 < len__25910__auto___38436)){
args38424.push((arguments[i__25911__auto___38437]));

var G__38438 = (i__25911__auto___38437 + (1));
i__25911__auto___38437 = G__38438;
continue;
} else {
}
break;
...
var vec__38427 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__38427,(0),null);
var arity = cljs.core.nth.call(null,vec__38427,(1),null);
var vec__38430 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__38430,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__38430,(1),null);
var vec__38433 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__38433,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__38433,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__38433,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__38433,(3),null);
...
var args38440 = [];
var len__25910__auto___38446 = arguments.length;
var i__25911__auto___38447 = (0);
while(true){
if((i__25911__auto___38447 < len__25910__auto___38446)){
args38440.push((arguments[i__25911__auto___38447]));

var G__38448 = (i__25911__auto___38447 + (1));
i__25911__auto___38447 = G__38448;
continue;
} else {
}
break;
...
var vec__38443 = result;
var munged_ns = cljs.core.nth.call(null,vec__38443,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__38443,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__38443,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__38443,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__38443,(4),null);
var arity = cljs.core.nth.call(null,vec__38443,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__38456 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__38456,(0),null);
var args = cljs.core.nth.call(null,vec__38456,(1),null);
var vec__38459 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__38459,(0),null);
var name = cljs.core.nth.call(null,vec__38459,(1),null);
...
var G__38462 = (arity + (1));
var G__38463 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38464){
var vec__38468 = p__38464;
var arity = cljs.core.nth.call(null,vec__38468,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__38468,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__24835__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__24835__auto__)){
return or__24835__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__38471_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__38472_SHARP_);
...
var args__25917__auto__ = [];
var len__25910__auto___38479 = arguments.length;
var i__25911__auto___38480 = (0);
while(true){
if((i__25911__auto___38480 < len__25910__auto___38479)){
args__25917__auto__.push((arguments[i__25911__auto___38480]));

var G__38481 = (i__25911__auto___38480 + (1));
i__25911__auto___38480 = G__38481;
continue;
} else {
}
break;
...
var argseq__25918__auto__ = ((((1) < args__25917__auto__.length))?(new cljs.core.IndexedSeq(args__25917__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__25918__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38475){
var vec__38476 = p__38475;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__38476,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38473){
var G__38474 = cljs.core.first.call(null,seq38473);
var seq38473__$1 = cljs.core.next.call(null,seq38473);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__38474,seq38473__$1);
});
...
var G__38483 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__38483) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__24835__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__24835__auto__)){
return or__24835__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__24823__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__24835__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__24835__auto__)){
return or__24835__auto__;
} else {
...
var map__38490 = options;
var map__38490__$1 = ((((!((map__38490 == null)))?((((map__38490.cljs$lang$protocol_mask$partition0$ & (64))) || (map__38490.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38490):map__38490);
var include_ns_QMARK_ = cljs.core.get.call(null,map__38490__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__38490__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__38490__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__38490__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__38491 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__38491,(0),null);
var fn_name = cljs.core.nth.call(null,vec__38491,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__38491,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__38491,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__38491,(4),null);
var arity = cljs.core.nth.call(null,vec__38491,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__24823__auto__ = protocol_ns;
if(cljs.core.truth_(and__24823__auto__)){
return cljs.core.not.call(null,(function (){var and__24823__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__24835__auto__ = protocol_part;
if(cljs.core.truth_(or__24835__auto__)){
return or__24835__auto__;
} else {
return fn_part;
...
var o__38168__auto__ = f;
return goog.object.get(o__38168__auto__,"getBasis").call(o__38168__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__24823__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__24823__auto__)){
...
}catch (e38496){var e__38193__auto__ = e38496;
...
var G__38497 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__38498 = cljs.core.rest.call(null,path);
obj = G__38497;
path = G__38498;
continue;
} else {
...
var partition_bits = (function (){var or__24835__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__24835__auto__)){
return or__24835__auto__;
} else {
return (0);
...
return (function (accum,p__38503){
var vec__38504 = p__38503;
var bit = cljs.core.nth.call(null,vec__38504,(0),null);
var protocol = cljs.core.nth.call(null,vec__38504,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__38507){
...
var selector = cljs.core.nth.call(null,vec__38511,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__38520,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__38520,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__38520,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__38514_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__38514_SHARP_));
});})(name,sorted_matches,vec__38520,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1492365313550